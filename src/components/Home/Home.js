			...
			<div className='main text-justify dark'>
				<div className='row description justify-content-center'>
					<div className='content d-flex flex-column justify-content-center align-content-center col-lg-6'>
						<p>Hi, I’m Sebastián Mancha (/seβasˈtjan ˈmant͡ʃa/ or /səbˈæst͡ʃɪn ˈmɑnt͡ʃə/, whichever is easiest), a graduate student in <a className='dark' href='https://linguistics.umd.edu/' target='_blank'>Linguistics</a> at the University of Maryland, where I’m supported by an NSF Graduate Research Fellowship. I’m advised by <a className='dark' href='https://ellenlau.net/' target='_blank'> Ellen Lau</a> and <a className='dark' href='https://www.colinphillips.net/' target='_blank'> Colin Phillips</a>. I did my undergraduate degrees in Linguistics and Spanish/Portuguese at the University of Texas, working with <a className='dark' href='https://sites.google.com/a/utexas.edu/jbeavers/' target='_blank'>John Beavers</a> and <a className='dark' href='https://liberalarts.utexas.edu/spanish/faculty/ajt95' target='_blank'> Jacqueline Toribio</a>.</p>
