			...
			<div className='main text-justify dark'>
				<div className='row description justify-content-center'>
					<div className='content d-flex flex-column justify-content-center align-content-center col-lg-6'>
						...
						<p>Broadly, I study sentence memory and sentence production. I (try to) pull on threads from work on structural priming, grammatical encoding, Verbal Working Memory, and episodic memory to understand when, where, and why language users manage to build robust memory traces of sentence structures. I'm happy to approach these questions from cognitive, computational, and neural angles.</p>
						<p>In a past life I studied the dialectology of the Spanish of the southwestern US, a subject close to my Tejano heart. US. In fact, my journey into Linguistics started with a documentary/comparative study of the Spanish spoken in my home community in Odessa, TX. Check it out under <NavLink className='dark' to='/projects'> Projects</NavLink>!. If you're a hispanic scholar interested in pursuing psycho/neurolinguistics and have questions about the field, don't hesitate to get in touch!</p>
						<Contacts />
					</div>
				</div>
			</div>
